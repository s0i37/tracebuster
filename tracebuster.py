...
arg_parser.add_argument("nets", nargs="*", default=["192.168.0.0/16","172.16.0.0/12","10.0.0.0/8"], metavar="network", help="targets (192.168.0.0/16 172.16.0.0/12 10.0.0.0/8)")
